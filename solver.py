...
#     # pyscript.write('solveStatus', f'{iterations} iterations')
...
#     total = board[2]
#     step = board[3]
#     pyscript.write('solveStatus', 'Test 1')

#     step = step + 1
#     pyscript.write('solveStatus', 'Test 2')
#     pyscript.write('solveStatus', f'path = {path}')
#     path[row][col] = step
#     pyscript.write('solveStatus', 'Test 3')
#     total = total + grid[row][col]
#     pyscript.write('solveStatus', 'Test 4')
#     board = [row, col, total, step]
#     pyscript.write('solveStatus', 'Test 5')
#     if total == target and row == row_end and col == col_end:
#         is_solved = 1
#         return True
...
#     pyscript.write('solveStatus', 'Getting the grid')
#     for row in range(height):
#         for column in range(width):
#             grid[row][column] = Element(f'i{4*row+column+1}').element.value
    
#     pyscript.write('solveStatus', 'Getting the parameters')
#     row_start = Element('startRow').element.value
#     col_start = Element('startCol').element.value
#     row_end = Element('endRow').element.value
#     col_end = Element('endCol').element.value
#     target = Element('targetSum').element.value

#     pyscript.write('solveStatus', 'Some computing')
#     row_pos = row_start
#     col_pos = col_start
...
#     pyscript.write('solveStatus', 'Returning the board')
#     return board
...
#     pyscript.write('solveStatus', 'Getting the parameters')
#     row_start = Element('startRow').element.value
#     pyscript.write('o1', row_start)
#     col_start = Element('startCol').element.value
#     pyscript.write('o2', col_start)
#     row_end = Element('endRow').element.value
#     pyscript.write('o3', row_end)
#     col_end = Element('endCol').element.value
#     pyscript.write('o4', col_end)
#     target = Element('targetSum').element.value
#     pyscript.write('o5', target)

#     pyscript.write('solveStatus', 'Preparing..')
#     row_pos = row_start
#     col_pos = col_start
